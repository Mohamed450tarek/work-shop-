        ...
        {isDetailsOpen && (
          <div className="pb-6 space-y-3">
            <div className="flex justify-between">
              <span className="text-sm font-light text-muted-foreground">Product ID</span>
              <span className="text-sm font-light text-foreground">{product._id}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm font-light text-muted-foreground">Product Name</span>
              <span className="text-sm font-light text-foreground">{product.title}</span>
            </div>
            {averageRating > 0 && (
              <div className="flex justify-between">
        ...
        {isCareOpen && (
          <div className="pb-6 space-y-4">
            <ul className="space-y-2">
              ...
              <li className="text-sm font-light text-muted-foreground">• Store in a cool, dry place when not wearing</li>
              <li className="text-sm font-light text-muted-foreground">• Remove before swimming, exercising, or showering</li>
            </ul>
            <p className="text-sm font-light text-muted-foreground">
              For professional cleaning, visit your local store or contact our customer service team.
            </p>
          </div>
        )}
      </div>
